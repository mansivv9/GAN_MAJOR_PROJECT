# %% [code] {"execution":{"iopub.status.busy":"2023-01-26T12:48:20.463402Z","iopub.execute_input":"2023-01-26T12:48:20.463809Z","iopub.status.idle":"2023-01-26T12:49:46.851530Z","shell.execute_reply.started":"2023-01-26T12:48:20.463777Z","shell.execute_reply":"2023-01-26T12:49:46.849755Z"},"scrolled":true}
import pandas as pd
import pickle
import random
import gensim
...
def create_image_csv():
    rootdir = '/kaggle/working/CUB_200_2011/images'
...
def create_final_csv():
    rootdir = '/kaggle/input/birds-dataset/birds/text_c10'
...
def create_sentence_embeddings():
    ...
    model = gensim.models.KeyedVectors.load_word2vec_format('/kaggle/input/word2vecpretrainedmodel/GoogleNews-vectors-negative300.bin', binary=True)
